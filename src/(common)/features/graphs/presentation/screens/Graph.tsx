...
const GraphPage = () => {
    ...
    const { data: lineGraphData, isLoading: lineGraphLoading } =
        useLineGraphQuery()
    const { data: barGraphData, isLoading: barGraphLoading } =
        useBarGraphQuery()
    const { data: pieGraphData, isLoading: pieGraphLoading } =
        usePieGraphQuery()
    const { data: histogramGraphData, isLoading: histogramGraphLoading } =
        useHistogramGraphQuery()
    const { data: donutGraphData, isLoading: donutGraphLoading } =
        useDonutGraphQuery()
    const { data: scatterGraphData, isLoading: scatterGraphLoading } =
        useScatterGraphQuery()
